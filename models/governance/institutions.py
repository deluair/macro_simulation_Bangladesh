...
class GovernanceSystem:
    ...
    def __init__(self, config, data_loader):
        ...
        self.education_investment = self.governance_data.get('education_investment', 0.02)  # % of GDP
        ...
        self.healthcare_investment = self.governance_data.get('healthcare_investment', 0.025)  # % of GDP
    ...
    def update_healthcare_system(self, year, economic_system, demographic_system, environmental_system):
        ...
        base_investment_pct = self.healthcare_investment
        ...
        self.healthcare_investment = min(0.06, max(0.02,  # Between 2% to 6% of GDP
            base_investment_pct + (growth_effect + aging_effect + governance_effect) * time_delta))
            
        # Calculate absolute investment
        healthcare_budget = self.healthcare_investment * gdp
        ...
        hiring_factor = 0.1 * (self.healthcare_investment - 0.025)
        ...
        investment_effect = 0.05 * (self.healthcare_investment - 0.025)
