...
class GovernanceSystem:
    ...
    def __init__(self, config, data_loader):
        ...
        # Add direct access to key institutional attributes
        self.institutional_effectiveness = self.institutional_system.institutional_effectiveness
        self.corruption_index = self.institutional_system.corruption_index
        self.regulatory_quality = self.institutional_system.regulatory_quality
        self.political_stability = getattr(self.institutional_system, 'political_stability', 0.5)
        self.policy_effectiveness = 0.5  # Default value
    ...
    def initialize_policy_parameters(self):
        """Initialize policy parameters from governance data"""
        # Economic policies
        self.fiscal_policy = self.governance_data.get('fiscal_policy', 0.5)  # 0-1 scale
        self.monetary_policy = self.governance_data.get('monetary_policy', 0.5)  # 0-1 scale
        self.trade_policy = self.governance_data.get('trade_policy', 0.6)  # 0-1 scale
        self.industrial_policy = self.governance_data.get('industrial_policy', 0.55)  # 0-1 scale
        
        # Investment allocations (as % of GDP)
        ...
        self.research_investment = self.governance_data.get('research_investment', 0.01)
